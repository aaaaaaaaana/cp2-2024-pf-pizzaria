...
public class PizzariaResource implements ResourceDTO<PizzariaRequest, PizzariaResponse> {
    ...
    @Transactional
    @PostMapping
    public ResponseEntity<PizzariaResponse> save(@RequestBody OpcionalRequest r) {
    ...
    public ResponseEntity<ProdutoResponse> saveOpcional(@PathVariable Long id, @RequestBody ProdutoRequest repo){
        ...
        var entity = produtoService.toEntity(repo);
        cardapio.add(entity);
